...
public static function activate() {
    ...
    /**
     * Add a filter to pass along to the post_type class
     **/
    add_filter( 'plugin-name-post_types-rewrite-flush', '__return_true' );
...
class Plugin_Name_Post_Types {
	...
	if ( apply_filters( 'plugin-name-post_types-rewrite-flush', false ) ) {
		flush_rewrite_rules();
	}
